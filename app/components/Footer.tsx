...
const SOCIAL = [
  ...
  { label: "Instagram", href: "https://www.instagram.com/rajarajand_official", icon: <InstagramIcon /> },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/rajarajan-dhanasekaran-6ba5009a", icon: <LinkedInIcon /> },
  { label: "YouTube", href: "https://www.youtube.com/@RajarajanD_Official", icon: <YouTubeIcon /> },
];
